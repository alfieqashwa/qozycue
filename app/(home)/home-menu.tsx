...
export const HomeContent = ({ slug }: { slug: string | null }) => (
  <TabsContent value="home" className="mt-12">
    <Hero />
    <section className="flex w-full items-center justify-around px-6 py-6 sm:hidden">
    ...
    <motion.section
      ...
      className="flex flex-col items-center justify-center gap-4 sm:mt-8 sm:flex-row md:gap-8 lg:gap-16"
    >
      <DocumentationButton
        icon={
          <GiPoolTriangle
      ...
      <ShimmerButton className="h-11">
        ...
        >
          <Tv className="mr-2 animate-pulse text-fuchsia-500" />
          Tutorial
        </a>
      </ShimmerButton>
    </motion.section>
