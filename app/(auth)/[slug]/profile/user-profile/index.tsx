...
import { SubscriptionInfo } from "./subscription-info-dialog"
import { ToggleCustomLossMinute } from "./toggle-custom-loss-minute"
...
const CompanyProfileCard = ({
  ...
  const superAdminAccessLevel = ["ZENITH"].includes(user.role ?? "")
